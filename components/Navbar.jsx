  ...
  return (
    <div className='shadow-md w-full fixed top-0 left-0'>
        <nav className='header md:flex items-center justify-between bg-[#f1f3f4] py-4 md:px-10 px-7'>
            ...
            <ul className={`menu md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-[#f1f3f4] md:z-auto z-[-1] left-0 right-0 text-center w-full md:w-auto pl-0 transition-all duration-500 ease-in ${open ? 'top-20 opacity-100' : 'top-[-490px]'} md:opacity-100`}>
                {
                    Links.map((link) => (
