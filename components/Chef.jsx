            ...
            <div className='container max-w-4xl my-8 p-5 border-2 border-opacity-40 border-solid border-[#7f96bb] md:flex'>
                <Link href={`/${data[2].url}`}>
                    <div className='max-w-md md:w-full rsp:m-auto cursor-pointer'>
                        <Image src="/assets/coming-soon-photo.png" alt="Construction site with the words 'coming soon' written on it" width={1200} height={660} layout={"intrinsic"} className='w-full h-auto' lazy='loading' />
                    </div>
                </Link>
                <article className='relative w-full p-4 cs:ml-[20px]'>
                    <Link href={`/${data[2].url}`}>
                        <a className='see-more fl:float-right mt-4 flex relative' title='See More about my Client Project'>
