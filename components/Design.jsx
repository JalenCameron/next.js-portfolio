        ...
        <section>
            <div className='container max-w-4xl my-8 p-5 border-2 border-solid border-[#7f96bb] md:flex'>
                ...
                <div className='relative w-full p-4 cs:ml-[20px]'>
                    <Link href={"/"}>
                        <a className='see-more float-right mt-4 flex relative'>
                            <p className='relative font-bold tracking-wide'>See More</p>
                            <svg clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className='w-[30px] h-[24px] relative top-0'><path d="m14.523 18.787s4.501-4.505 6.255-6.26c.146-.146.219-.338.219-.53s-.073-.383-.219-.53c-1.753-1.754-6.255-6.258-6.255-6.258-.144-.145-.334-.217-.524-.217-.193 0-.385.074-.532.221-.293.292-.295.766-.004 1.056l4.978 4.978h-14.692c-.414 0-.75.336-.75.75s.336.75.75.75h14.692l-4.979 4.979c-.289.289-.286.762.006 1.054.148.148.341.222.533.222.19 0 .378-.072.522-.215z" fill-rule="nonzero"/></svg>
                        </a>
                    </Link>
                    <div className='project-info'>
                        <h3 className='my-3 mr-1'>{data[0].title}</h3>
                        <p className='my-2 italic font-bold'>{data[0].tools}</p>
                        <p>{data[0].overview}</p>
                    </div>
                </div>
            </div>
            ...
            <div className='container max-w-4xl my-8 p-5 border-2 border-solid border-[#7f96bb] md:flex'>
                ...
                <div className='relative w-full p-4 cs:ml-[20px]'>
                    ...
                    <div className='project-info'>
                        ...
                        <p className='my-2 italic font-bold'>{data[1].tools}</p>
                        <p>{data[1].overview}</p>
                    </div>
                </div>
            </div>
            ...
            <div className='container max-w-4xl my-8 p-5 border-2 border-solid border-[#7f96bb] md:flex'>
                ...
                <div className='relative w-full p-4 cs:ml-[20px]'>
                    ...
                    <div className='project-info'>
                        ...
                        <p className='my-2 italic font-bold'>{data[3].tools}</p>
                        <p>{data[3].overview}</p>
                    </div>
                </div>
            </div>
