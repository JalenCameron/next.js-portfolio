  ...
  return (
    <footer className='mt-4 p-4 bottom-0 left-0 w-full flex flex-row justify-between items-center max-w-3xl mx-auto'>
        ...
        <div className='flex flex-row'>
            <a href="mailto:jalenccameron@gmail.com" alt="Jalen's LinkedIn Profile">
                <FiMail className='w-6 h-6 mr-2 hover:text-[#7f96bb]' />
            </a>
            <a href="https://www.linkedin.com/in/jalen-cameron" alt="Jalen's LinkedIn Profile" target="_blank" rel="noopener noreferrer">
